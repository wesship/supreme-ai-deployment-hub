-- Forward-safe Hermes durable worker persistence migration.
-- The original 20260718 migration may be older than an already-applied remote ledger.
-- Re-declaring the idempotent schema here guarantees normal forward db push activation.
