"""Regression tests for user-safe upstream provider errors."""
...
def test_provider_capacity_error_is_classified_without_leaking_provider_body():
    ...
    assert message == _PROVIDER_CAPACITY_MESSAGE
