"""Pure safety gates for Jetson and smart-glasses commands."""
...
def evaluate_command(
    ...
    *,
    ...
    if command.kind in SENSITIVE_COMMANDS and not approved_sensitive_action:
        return CommandDecision(False, "sensitive smart-glasses action requires explicit approval", "sensitive")

    if command.kind in HIGH_IMPACT_COMMANDS and not approved_high_impact_action:
        return CommandDecision(False, "high-impact action requires explicit policy approval", "high-impact")
