...
async def set_workspace_policy(
    *,
    ...
    """Atomically update workspace policy and its audit evidence."""
    return await _rpc(
...
async def grant_approval(
    *,
    ...
    """Atomically create an expiring approval and its audit evidence."""
    return await _rpc(
...
async def revoke_approval(
    *,
    ...
    """Atomically revoke an active approval and its audit evidence."""
    return await _rpc(
