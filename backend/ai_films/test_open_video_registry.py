...
def test_registry_models_are_execution_disabled_by_default():
    assert get_video_model("wan2.2-ti2v-5b").execution_enabled is False
    assert get_video_model("ltx-2.x").execution_enabled is False
