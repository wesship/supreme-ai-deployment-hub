...
class RoleAuthoring:
    ...
    async def _advance(self, action: str, project_id: str, role_id: str, actor_id: str,
                       ...
                       digest: str | None = None, test_run_id: str | None = None) -> dict:
        return await self.store.role_rpc({"p_action": action, "p_project_id": project_id,
    ...
    async def mark_tested(self, project_id: str, role_id: str, actor_id: str,
        ...
        return await self._advance("test", project_id, role_id, actor_id, revision,
                                   digest=digest, test_run_id=evidence["nonce"])

    async def transition(self, action: str, project_id: str, role_id: str,
                         actor_id: str, revision: int) -> dict:
        ...
        return await self._advance(action, project_id, role_id, actor_id, revision)
