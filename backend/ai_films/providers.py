...
This module deliberately does not call external vendors. It provides a stable,
server-side registry that reports whether each production capability is ready
and validates requested provider names before render orchestration begins.
"""
