...
`src/platform/d3vonn` provides a stable TypeScript boundary for domain-event contracts, agent and marketplace manifests, browser-safe versus server-only environment parsing, and typed API event publication.
