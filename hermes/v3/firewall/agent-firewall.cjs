 ...
 *
 * Hermes v3 — Devonn.AI Agent Execution Firewall
 *
...
// Default permission tiers for known Devonn.AI agent types
const DEFAULT_AGENT_TIERS = {
  "devonn-copilot":        "contributor",
  "devonn-deployer":       "deployer",
  "devonn-security-bot":   "read-only",
  "devonn-release-bot":    "deployer",
