...
function DeferredProviders({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => { const id = ('requestIdleCallback' in window) ? (window as any).requestIdleCallback(() => setReady(true)) : setTimeout(() => setReady(true), 50); return () => { if ('cancelIdleCallback' in window) (window as any).cancelIdleCallback(id); else clearTimeout(id); }; }, []);
...
function App() {
  ...
  return (
    <ThemeProvider attribute="class" defaultTheme="dark" enableSystem>
      <Router><ScrollToTop /><LegacyFilmPathRepair /><SkipToContent /><Suspense fallback={null}><Navbar /></Suspense>
        <DeferredProviders><main id="main-content" tabIndex={-1} className="min-h-screen pt-16 focus:outline-none"><Suspense fallback={<PageLoader />}><Routes>
          ...
          <Route path="/moneyhub" element={<MoneyHub />} /><Route path="/ai-therapy" element={<AITherapy />} /><Route path="/therapy" element={<AITherapy />} /><Route path="/sovereignty" element={<SovereigntyMatrix />} /><Route path="/sovereignty-matrix" element={<SovereigntyMatrix />} /><Route path="/music" element={<Music />} /><Route path="/backtesting" element={<Backtesting />} /><Route path="/jetson" element={<JetsonControl />} /><Route path="/jetson-control" element={<JetsonControl />} /><Route path="/app" element={<AuthenticatedRoute><LaunchApp /></AuthenticatedRoute>} /><Route path="/ai-agents" element={<AIAgents />} /><Route path="/business-automation" element={<BusinessAutomation />} />
          <Route path="/solutions" element={<Solutions />} /><Route path="/resources" element={<Resources />} /><Route path="/security" element={<Security />} /><Route path="/security/disclosure" element={<SecurityDisclosure />} /><Route path="/enterprise" element={<Security />} /><Route path="/enterprise-readiness" element={<EnterpriseReadiness />} /><Route path="/assurance" element={<AdminRoute><AssuranceConsole /></AdminRoute>} /><Route path="/security/ops" element={<SecurityOps />} /><Route path="/security/dashboard" element={<SecurityDashboard />} /><Route path="/security/command-center" element={<SecurityCommandCenter />} /><Route path="/security/secrets" element={<AdminRoute><SecretsVault /></AdminRoute>} /><Route path="/pricing" element={<Pricing />} /><Route path="/research-os" element={<ResearchOS />} />
        ...
        </Routes></Suspense></main><Suspense fallback={null}><FloatingChatWidget /></Suspense></DeferredProviders>
