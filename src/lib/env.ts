 ...
 *   VITE_SENTRY_DSN
 *   VITE_ENVIRONMENT
 *   VITE_HNF_RADIO_STREAM_URL
 *   VITE_HNF_RADIO_NOW_PLAYING_URL
 *
...
const PUBLIC_ENV = {
  ...
  hnfRadioStreamUrl: import.meta.env.VITE_HNF_RADIO_STREAM_URL as string | undefined,
  hnfRadioNowPlayingUrl: import.meta.env.VITE_HNF_RADIO_NOW_PLAYING_URL as string | undefined,
} as const;
...
export const env = {
  ...
  /** Public HNF Radio stream URL generated by AzuraCast after station provisioning. */
  hnfRadioStreamUrl: PUBLIC_ENV.hnfRadioStreamUrl?.trim() ?? '',

  /** Public AzuraCast Now Playing endpoint for HNF Radio. */
  hnfRadioNowPlayingUrl: PUBLIC_ENV.hnfRadioNowPlayingUrl?.trim() ?? '',
