/**
 * D3VONN Multi-Agent Router — Phase 5
...
const AGENT_PROMPTS: Record<AgentType, string> = {
  orchestrator: `You are the Orchestrator Agent for D3VONN. Your role is to:
...
Always respond with a JSON plan: {"subtasks": [{"agent": "type", "task": "description"}], "synthesis_needed": true/false}`,
  ...
  researcher: `You are the Research Agent for D3VONN. Your role is to:
...
Use the search_documentation and get_deployment_status tools when relevant.`,
  ...
  coder: `You are the Code Agent for D3VONN. Your role is to:
...
Always include error handling and follow the existing TypeScript/Python patterns.`,
  ...
  deployer: `You are the Deployment Agent for D3VONN. Your role is to:
...
Use trigger_github_workflow and get_deployment_status tools.`,
  ...
  monitor: `You are the Monitor Agent for D3VONN. Your role is to:
...
Use get_system_metrics and get_deployment_status tools.`,
  ...
  analyst: `You are the Analysis Agent for D3VONN. Your role is to:
