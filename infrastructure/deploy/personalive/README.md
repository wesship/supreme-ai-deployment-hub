# D3VONN PersonaLive Avatar Stack

This folder contains an isolated Docker Compose stack for running PersonaLive beside D3VONN without touching the main app deployment.
