...
export const PUBLIC_ROUTES = [
  ...
  ['/glasses/', 'D3VONN Wearable Display Preview', 'Preview the D3VONN wearable display interface for glanceable, governed AI actions. Hardware and backend integrations remain certification-gated.', 'WebApplication', 'monthly', '0.6'],
