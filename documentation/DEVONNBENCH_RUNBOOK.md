...
```text
.github/workflows/d3vonnbench-security.yml
```
...
```text
d3vonnbench-security-artifacts
```
...
```bash
python -m pip install -r requirements-d3vonnbench.txt
python -m d3vonnbench.cli run d3vonnbench/suites/security-smoke.yaml \
