...
This document defines the required secrets, environment separation rules, and deployment integrity expectations for D3VONN.
...
D3VONN should not be promoted to production unless required secrets are present, scoped correctly, environment-separated, and not exposed to the frontend bundle.
