...
Move D3VONN from merged OCC milestone to production launch readiness by deploying the backend, applying the Supabase OCC migration, validating admin security, and tagging the OCC release.
...
4. Deploy the `d3vonn-backend` web service.
5. Confirm health:
...
git tag -a v1.1.0-occ -m "D3VONN Operator Command Center v1.1.0"
