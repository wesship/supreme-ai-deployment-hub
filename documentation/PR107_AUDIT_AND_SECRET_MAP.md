...
| `scaffold/d3vonn-coordinator/.env.example` | LOW — template only | Keep |
...
```yaml
DATABASE_URL=postgresql://d3vonn:d3vonn_secret@db:5432/d3vonn_dev
POSTGRES_PASSWORD: d3vonn_secret
```
...
| `VERCEL_PREVIEW_URL` | Your Vercel preview domain e.g. `d3vonn.vercel.app` | `deploy.yml`, `deploy-and-publish.yml` |
