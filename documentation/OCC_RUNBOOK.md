# D3VONN Operator Command Center Runbook

_Last updated: 2026-05-27_

## Purpose

The Operator Command Center (OCC) is the admin-grade control layer for D3VONN. It provides a protected dashboard and backend API for monitoring AI usage, agent activity, tool calls, RAG documents, approvals, error logs, and user plan controls.
